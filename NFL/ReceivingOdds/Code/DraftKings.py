...
engine = BrowserEngine("https://sportsbook.draftkings.com/leagues/football/nfl?category=player-stats&subcategory=rec-yards", headless=False, delay=1)
...
with open('NFL/ReceivingOdds/Data/DraftKings.csv', 'w', newline='') as file:
