...
engine.doAction(Locator.click, engine.getObject(Page.get_by_text, args=["Show More"], delay=1).nth(3))
engine.doAction(Locator.click, engine.getObject(Page.get_by_text, args=["Show More"], delay=1).nth(3))
...
table = table.find_all('ms-period-option-group', class_='ng-star-inserted')[2]
...
with open('NFL/ReceivingOdds/Data/BetMGM.csv', 'w', newline='') as file:
