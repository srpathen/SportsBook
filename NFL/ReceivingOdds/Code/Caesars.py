...
engine.doAction(Locator.click, engine.getObject(Page.get_by_text, args=["Total Regular Season Receiving Yards"]))
for i in range(140):
...
with open('NFL/ReceivingOdds/Data/Caesars.csv', 'w', newline='') as file:
