...
engine = BrowserEngine("https://sportsbook.draftkings.com/leagues/football/nfl?category=player-stats&subcategory=pass-yards", headless=False, delay=1)
...
with open('NFL/PassingOdds/Data/DraftKings.csv', 'w', newline='') as file:
